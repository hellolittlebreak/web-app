...
const CongratulationsGratitude = () => {
    ...
    useEffect(() => {
        logEvent(analytics, 'screen_view', {
            firebase_screen: "CongratulationsGratitude"
        });
    }, [analytics])
    ...
    return <div className='flex pb-32'>
        ...
        <div className='mx-auto w-full lg:w-1/2 ' >
            ...
            <p className="font-heading font-bold text-blue-1100 mx-8 my-8">In this "Gratitude and appreciation" short exercise, you reflected on what you are grateful for:</p>
...
export default CongratulationsGratitude;
